...
function AdminDashboard({ onViewCase }) {
            ...
            upcomingFollowups.map(c => {
              ...
              return (
                <div key={c.id} style={styles.alertRow}>
                  <span style={styles.alertCaseNum}>#{c.case_number}</span>
                  <span style={styles.alertLocation}>{c.location || c.description?.slice(0, 40)}</span>
                  <span style={days <= 3 ? styles.alertDate : styles.alertDateSoon}>
            ...
            <tbody>
              {filteredCases.map(c => (
                <tr key={c.id}>
                  ...
                  <td style={styles.td} style={{ ...styles.td, maxWidth: '200px' }}>
                    {c.location || '—'}
                  </td>
